...
const accounts = [
  ...
  },
  {
    ...
    movements: [
      5000, 3400, -1500, -790, -3210, -1000, 9500, -3000, 7500, -1850,
    ],
    interestRate: 1.3, // %
    password: 20135570,
    movementsDates: [
  ...
  {
    owner: "Khairun Nahar Lamia",
    movements: [
      5000, 5400, -1500, -790, -3210, -1000, 9500, -3000, 1500, -1850,
    ],
    interestRate: 1.3, // %
    password: 20135624,
    movementsDates: [
  ...
  {
    owner: "Tamanna Tabassum",
    movements: [
      4000, 5400, -1500, -790, -3210, -1000, 7500, -3000, 3500, -1850,
    ],
    interestRate: 1.3, // %
    password: 20135568,
    movementsDates: [
  ...
  {
    owner: "Afrin Zahan Sreety",
    movements: [7000, 3400, -1500, -790, -2210, -2000, 8500, -300, 1500, -1850],
    interestRate: 1.3, // %
    password: 20135541,
    movementsDates: [
      "2022-12-11T21:31:17.671Z",
  ...
  {
    owner: "Ayesha Afifa",
    movements: [2000, 7400, -150, -790, -3210, -1000, 6500, -300, 1500, -1850],
    interestRate: 1.3, // %
    password: 20135637,
    movementsDates: [
      "2022-12-11T21:31:17.671Z",
